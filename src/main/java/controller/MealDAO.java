...
public class MealDAO {
	...
	public boolean insertArticle(ArrayList<MealVO> list) {
	...
	public ArrayList<MealVO> getDiet() {
	...
	public static void main(String[] args) {
		...
		ArrayList<MealVO> list = dao.getDiet();
